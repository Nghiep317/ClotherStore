<%-- 
    Document   : categories
    Created on : Jun 7, 2024, 1:42:29 PM
    Author     : wvrtu
--%>
...
<%@ page import="Models.ProductVariation" %>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                                    ...
                                    <c:forEach items="${products}" var="product">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                    <img src="img/product/${product.coverImg}" alt="">
                                                </div>
                                                <div class="l_p_text">
                                                    <ul>
                                                        <li><a class="add_cart_btn" href="product?action=details&product_id=${product.productId}">View Detail</a></li>
                                                    </ul>
                                                    <h4>${product.productName}</h4>
                                                    <c:set var="variations" value="${productDAO.getAllProductVariations(product)}"/>

                                                        <c:if test="${not empty variations}">
                                                            <h5>${variations[0].price}</h5>
                                                        </c:if>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <nav aria-label="Page navigation example" class="pagination_area">
                                    ...
                                    <div class="pagination">
                                        <c:if test="${not empty category_id}">
                                            <ul>
                                                <c:forEach begin="${1}" end="${num}" var="i">
                                                    <li class="page-item"><a href="product?action=listByCategory&category_id=${category_id}&page=${i}">${i}</a></li>
                                                    </c:forEach>
                                        ...
                                        <c:if test="${empty category_id}">
                                            <ul>
                                                <c:forEach begin="${1}" end="${num}" var="i">
                                                    <li class="page-item"><a href="product?page=${i}">${i}</a></li>
                                                    </c:forEach>
                                                <li class="page-item next"><a class="page-link" href="#"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </c:if>
                        ...
                        <div class="col-lg-3 float-md-right">
                            <div class="categories_sidebar">
                                <aside class="l_widgest l_p_categories_widget">
                                    ...
                                    <ul class="navbar-nav">
                                        <li>
                                            <a class="nav-link" href="product">All
                                                <i class="icon_plus" aria-hidden="true"></i>
                                                <i class="icon_minus-06" aria-hidden="true"></i>
                                            </a></li>
                                            <c:forEach items="${categories}" var="category">
                                            <li>
                                                <a class="nav-link" href="product?action=listByCategory&category_id=${category.categoryId}">${category.categoryName}
                                                    <i class="icon_plus" aria-hidden="true"></i>
                                                    <i class="icon_minus-06" aria-hidden="true"></i>
                                                </a></li>
                                            </c:forEach>
