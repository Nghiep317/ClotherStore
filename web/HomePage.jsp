<%-- 
    Document   : HomePage
    Created on : Jun 5, 2024, 1:13:43 AM
    Author     : thien
--%>
    ...
    <body>
                        ...
                        <c:forEach var="product" items="${products}" varStatus="loop">
                            <div class="item">
                                <div class="product_img">
                                    <img id="product-img-${loop.index}" src="img/product/l-product-${loop.index + 1}.jpg" alt="${product.productName}" />
                                </div>
        ...
        <script>
                            document.addEventListener("DOMContentLoaded", function () {
                                // JavaScript to be executed after DOM is fully loaded
                                var productImages = document.querySelectorAll('.l_product_slider img');
                                productImages.forEach(function (img, index) {
                                    img.src = `img/product/l-product-${index + 1}.jpg`; // Adjust index as needed
                                });
