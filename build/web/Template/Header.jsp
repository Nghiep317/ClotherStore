<%-- 
    Document   : Header
    Created on : Jun 7, 2024, 7:35:11 AM
    Author     : thien
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<%=path%>/img/fav-icon.png" type="image/x-icon" />
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        <title>Persuit</title>

        <!-- Icon css link -->
        <link href="<%=path%>/css/font-awesome.min.css" rel="stylesheet">
        <link href="<%=path%>/vendors/line-icon/css/simple-line-icons.css" rel="stylesheet">
        <link href="<%=path%>/vendors/elegant-icon/style.css" rel="stylesheet">
        <!-- Bootstrap -->
        <link href="css/bootstrap.min.css" rel="stylesheet">
        
        <!-- Rev slider css -->
        <link href="<%=path%>/vendors/revolution/css/settings.css" rel="stylesheet">
        <link href="<%=path%>/vendors/revolution/css/layers.css" rel="stylesheet">
        <link href="<%=path%>/vendors/revolution/css/navigation.css" rel="stylesheet">
        
        <!-- Extra plugin css -->
        <link href="<%=path%>/vendors/owl-carousel/owl.carousel.min.css" rel="stylesheet">
        <link href="<%=path%>/vendors/bootstrap-selector/css/bootstrap-select.min.css" rel="stylesheet">
        <link href="<%=path%>/vendors/jquery-ui/jquery-ui.css" rel="stylesheet">
