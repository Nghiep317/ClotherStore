...
<head>
    ...
    <style>
        ...
        input[type="submit"] {
            ...
            background-color: #fff; /* Màu nền nút Sign Up */
            color: #000; /* Màu chữ đen */
            margin-bottom: 10px;
        }
    ...
    <div id="form">
        ...
        <div id="form-content">
            <form action="Register" method="post">
                <label>Username<span style="color: blue;">*</span></label><br/>
                <input type="text" name="txtCopName" value="${param.txtCopName}"><br/>
                <span class="msg-error">${msgCPN}</span><br/>

                <label>Email<span style="color: red;">*</span></label><br/>
                <input type="text" name="txtEmail" value="${param.txtEmail}"><br/>
                <span class="msg-error">${msgE}</span><br/>

                <label>Password<span style="color: red;">*</span></label><br/>
                <input type="password" name="txtPass"/><br/>
                <span class="msg-error">${msgP}</span><br/>

                <label>Re-Password<span style="color: red;">*</span></label><br/>
                <input type="password" name="txtRePass"/><br/>
                <span class="msg-error">${msgRP}</span><br/>
